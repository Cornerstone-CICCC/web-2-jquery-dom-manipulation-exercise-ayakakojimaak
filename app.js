...
$(function () {
  ...
  $("#exercise2Button").on("click", function () {
    $("#exercise2 p").parent("div").css({ background: "blue" });
  });
  ...
  $("#exercise3Button").on("click", function () {
    $("#exercise3 p").parent("div").css({ background: "blue" });
  });
  ...
  $("#exercise4Button").on("click", function () {
    $(this).parent("div").find("p").eq(1).css({ display: "none" });
  });
  ...
  $("#exercise5Button").on("click", function () {
    $(this).next().children("p").css({ border: "1px solid" });
  });
  ...
  $("#exercise6Button").on("click", function () {
    $(this).parent("div").find("div").eq(1).find("ul>li").last().css({ color: "red" });
  });
});
